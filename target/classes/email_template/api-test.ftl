                            ...
                            <div style="margin: 0px auto; padding: 0px 10px; width: 680px;">
                                <div
                                    ...
                                    <strong style="margin-bottom: 15px; display: block;">亲爱的Tester：
                                        您好！以下是接口自动化任务【${params.jobname}】执行情况。</strong>
                                    <br>
                                    ...
                                    <p> 请及时前往<a href='http://${params.webip}:${params.webport}${params.contextpath}/#/apiTest/report/detail?id=${params.planLogId}' target="_blank">RabbitTest平台</a>查看您的任务执行的更多细节</p>
                                    <p>
                                </div>
                        </td>
                    </tr>
